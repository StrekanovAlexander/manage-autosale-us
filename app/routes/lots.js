...
router.get('/deactivated', auth, lotController.deactivated);
...
router.get('/deactivated/:id/details', auth, lotController.details);
...
router.get('/deactivated/:id/files', lotController.files);
